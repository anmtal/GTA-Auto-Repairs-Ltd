/* ============================================================
   GTA AUTO REPAIRS LTD. — interactions (shared across all pages)
...
(function () {
  ...
  const CONFIG = {
    email: "info@gtaautorepairs.ca",
    phone: "9056391555",
    instagram: "https://www.facebook.com/p/GTA-Auto-Repair-Ltd-100054621751437/",
    endpoint: ""
  };
  window.GTAAUTO = CONFIG;
  ...
  if (form) {
    ...
    on(form, "submit", async (e) => {
      ...
      const lead = {
        source: "gta-auto-website", name: data.name, phone: data.phone, email: data.email || "",
      ...
      const bodyLines = [
        "Hi GTA Auto, I'd like to book a service.", "",
        `Vehicle: ${vehicle || "—"}`,
